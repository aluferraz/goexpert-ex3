...
func (x *ListAllOrders) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListAllOrders) ProtoMessage() {}

func (x *ListAllOrders) ProtoReflect() protoreflect.Message {
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListAllOrders.ProtoReflect.Descriptor instead.
func (*ListAllOrders) Descriptor() ([]byte, []int) {
	return file_internal_infra_grpc_protofiles_order_proto_rawDescGZIP(), []int{3}
}

func (x *ListAllOrders) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListAllOrders) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *ListAllOrders) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *ListAllOrders) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
type ListAllOrdersResponse struct {
	...
	Order []*ListAllOrders `protobuf:"bytes,1,rep,name=order,proto3" json:"order,omitempty"`
}
...
func (x *ListAllOrdersResponse) GetOrder() []*ListAllOrders {
	if x != nil {
		return x.Order
	}
	return nil
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x16,
	0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x68, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c,
	0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x22, 0x40, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x05, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69,
	0x73, 0x74, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x05, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x32, 0x94, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x73, 0x12, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c,
	0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19,
	0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []interface{}{
	...
	(*ListAllOrdersRequest)(nil),  // 2: pb.ListAllOrdersRequest
	(*ListAllOrders)(nil),         // 3: pb.ListAllOrders
	(*ListAllOrdersResponse)(nil), // 4: pb.ListAllOrdersResponse
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.ListAllOrdersResponse.order:type_name -> pb.ListAllOrders
	0, // 1: pb.OrderService.CreateOrder:input_type -> pb.CreateOrderRequest
	2, // 2: pb.OrderService.ListAllOrders:input_type -> pb.ListAllOrdersRequest
	1, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
	4, // 4: pb.OrderService.ListAllOrders:output_type -> pb.ListAllOrdersResponse
